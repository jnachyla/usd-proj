...
num_actions = env.observation_space.shape[0]  #2 #1 #env.action_space.n  # 2
...
# # `Pendulum` is considered solved if average reward is >= -0.5 over 500
# # consecutive trials - tak przyjelam na razie
reward_threshold = -0.5
running_reward = -16.2736044 #najgorsza moliwa nagroda - z dokumentacji pendulum
# 
...
render_env = gym.make("Pendulum-v0", render_mode='rgb_array')
